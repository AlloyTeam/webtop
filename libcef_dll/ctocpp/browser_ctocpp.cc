...
void CefBrowserCToCpp::GoHome() {
  if (CEF_MEMBER_MISSING(struct_, go_home))
    return;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  struct_->go_home(struct_);
}
...
CefString CefBrowserCToCpp::GetFrameTitle(CefRefPtr<CefFrame> frame) {
  if (CEF_MEMBER_MISSING(struct_, get_frame_title))
    return CefString();
  ...
  // Execute
  cef_string_userfree_t _retval = struct_->get_frame_title(struct_,
...
CefString CefBrowserCToCpp::GetFrameNameByIndex(int idx) {
  if (CEF_MEMBER_MISSING(struct_, get_frame_name_by_index))
    return CefString();

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  cef_string_userfree_t _retval = struct_->get_frame_name_by_index(struct_,
      idx);
