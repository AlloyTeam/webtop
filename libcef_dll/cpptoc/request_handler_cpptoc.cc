...
void CEF_CALLBACK request_handler_on_http_response(
    struct _cef_request_handler_t* self, const cef_string_t* url,
    const cef_string_t* mimeType, int responseCode, int64 contentLength,
  ...
  // Execute
  CefRequestHandlerCppToC::Get(self)->OnHttpResponse(
      CefString(url),
      CefString(mimeType),
      responseCode,
      contentLength,
...
CefRequestHandlerCppToC::CefRequestHandlerCppToC(CefRequestHandler* cls)
  ...
  struct_.struct_.on_http_response = request_handler_on_http_response;
}
