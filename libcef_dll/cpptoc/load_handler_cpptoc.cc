...
void CEF_CALLBACK load_handler_on_caught_jserror(
    struct _cef_load_handler_t* self, const cef_string_t* message,
    int line_number) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  CefLoadHandlerCppToC::Get(self)->OnCaughtJSError(
      CefString(message),
      line_number);
}

void CEF_CALLBACK load_handler_on_plugin_missing(
    struct _cef_load_handler_t* self, const cef_string_t* mimeType) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  CefLoadHandlerCppToC::Get(self)->OnPluginMissing(
      CefString(mimeType));
}
...
CefLoadHandlerCppToC::CefLoadHandlerCppToC(CefLoadHandler* cls)
  ...
  struct_.struct_.on_caught_jserror = load_handler_on_caught_jserror;
  struct_.struct_.on_plugin_missing = load_handler_on_plugin_missing;
}
