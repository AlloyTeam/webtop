...
int CEF_CALLBACK v8value_execute_function_with_string_param(
    struct _cef_v8value_t* self, cef_v8context_t* context,
    struct _cef_v8value_t* object, const cef_string_t* strargs) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  if (!context)
    return 0;
  // Verify param: strargs; type: string_byref_const
  DCHECK(strargs);
  if (!strargs)
    return 0;
  // Unverified params: object
  ...
  // Execute
  bool _retval = CefV8ValueCppToC::Get(self)->ExecuteFunctionWithStringParam(
      CefV8ContextCppToC::Unwrap(context),
      CefV8ValueCppToC::Unwrap(object),
      CefString(strargs));
...
CefV8ValueCppToC::CefV8ValueCppToC(CefV8Value* cls)
  ...
  struct_.struct_.execute_function_with_string_param =
      v8value_execute_function_with_string_param;
}
