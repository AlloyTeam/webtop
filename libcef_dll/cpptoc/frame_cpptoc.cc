...
struct _cef_frame_t* CEF_CALLBACK frame_get_child(struct _cef_frame_t* self,
    int index) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  CefRefPtr<CefFrame> _retval = CefFrameCppToC::Get(self)->GetChild(
      index);
...
CefFrameCppToC::CefFrameCppToC(CefFrame* cls)
  ...
  struct_.struct_.get_child = frame_get_child;
